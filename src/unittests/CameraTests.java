...
public class CameraTests {
	/**
     * Test method for elements.Camera c-tor
     */
    @Test
    public void testConstructor() {
    	try {
    		new Camera(new Point3D(0,0,0),new Vector(0,0,1),new Vector(0,0.5,0.5));
    	}
    	catch(Exception e) {}
    	Camera camera=new Camera(new Point3D(0,0,0),new Vector(-1,0,0),new Vector(0,-1,0));
    	assertEquals("wrong third vector",new Vector(0,0,1), camera.getvRight());
