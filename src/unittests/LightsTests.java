...
public class LightsTests {
    ...
    public void trianglesDirectional() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0), 20));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
    ...
    public void trianglesSpot() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0), 40));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15));
    ...
    public void sphereNarrowSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
                new Vector(1, -1, 2), 1, 0.00001, 0.00000001,9));

        ImageWriter imageWriter = new ImageWriter("sphereNarrowSpot", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    /**
     * Produce a picture of a sphere lighted by a many sources of light
     */
    @Test
    public void sphereLights() {
        ...
        scene.addLights(new DirectionalLight(new Color(450, 200, 150), new Vector(0, 0, 1)));
        scene.addLights(new PointLight(new Color(250, 250, 250), new Point3D(50, -50, -50), 1, 0.0005, 0.000001));

        ImageWriter imageWriter = new ImageWriter("sphereSomelights", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    /**
     * Produce a picture of two triangles lighted by a many sources of light
     */
    @Test
    public void trianglesLight() {
        ...
        scene.addGeometries(
                ...
                new Triangle(Color.BLACK, new Material(0.5, 0.5, 300),
                        new Point3D(-150, 150, 150), new Point3D(-70, -70, 50), new Point3D(75, -75, 150)));
       scene.addLights(new PointLight(new Color(0, 300, 500),new Point3D(10, -10,130),1, 0.0005, 0.00005));
       scene.addLights(new SpotLight(new Color(250, 250, 250),
             new Point3D(10, 10, 130), new Vector(-2, 2, 1), 1, 0.0001, 0.00005));

        ImageWriter imageWriter = new ImageWriter("trianglesSomeLights", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
