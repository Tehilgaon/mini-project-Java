...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        List<GeoPoint> r = sphere.findIntersections(new Ray(new Point3D(0.5, 0, 0),new Vector(1, 0, 0)));
        ...
        assertEquals("Wrong ray's direction ",new Point3D(2,0,0),result.get(0).point);
        ...
        assertEquals("Wrong number of points", 2, result.size());
        assertEquals("Ray crosses sphere", List.of(p2, p1), List.of(result.get(0).point,result.get(1).point));
        
        // TC14: Ray starts at sphere and goes inside (1 points)
        result = sphere.findIntersections(new Ray(new Point3D(1, 0, 1),new Vector(0, 0, -1)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray crosses sphere", new Point3D(1,0,-1), result.get(0).point);
        ...
        assertEquals("Ray crosses sphere", null, sphere.findIntersections(new Ray(new Point3D(-1,0,1),new Vector(1, 0, 0))));
